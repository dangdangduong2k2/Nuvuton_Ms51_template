      ...
      000083 43 89 01         [24]  571 	orl	_TMOD,#0x01
                                    572 ;	lib/delay.c:9: TMOD &= ~(1 << 1);
      000086 53 89 FD         [24]  573 	anl	_TMOD,#0xfd
                                    574 ;	lib/delay.c:10: CKCON |= (1 << 3);
      000089 43 8E 08         [24]  575 	orl	_CKCON,#0x08
                                    576 ;	lib/delay.c:11: TMOD &= ~(1 << 2);
      00008C 53 89 FB         [24]  577 	anl	_TMOD,#0xfb
                                    578 ;	lib/delay.c:12: TMOD &= ~(1 << 3);
      00008F 53 89 F7         [24]  579 	anl	_TMOD,#0xf7
                                    580 ;	lib/delay.c:13: }
      000092 22               [24]  581 	ret
                                    582 ;------------------------------------------------------------
                                    ...
                                    590 ;	-----------------------------------------
      000093                        591 _Delay_Ms:
      000093 AE 82            [24]  592 	mov	r6, dpl
      000095 AF 83            [24]  593 	mov	r7, dph
                                    594 ;	lib/delay.c:17: while (u16Delay) {
      000097                        595 00101$:
      000097 EE               [12]  596 	mov	a,r6
      000098 4F               [12]  597 	orl	a,r7
      000099 60 12            [24]  598 	jz	00104$
                                    599 ;	lib/delay.c:18: --u16Delay;
      00009B 1E               [12]  600 	dec	r6
      00009C BE FF 01         [24]  601 	cjne	r6,#0xff,00120$
      00009F 1F               [12]  602 	dec	r7
      0000A0                        603 00120$:
                                    604 ;	lib/delay.c:19: delay_1ms();
      0000A0 C0 07            [24]  605 	push	ar7
      0000A2 C0 06            [24]  606 	push	ar6
      0000A4 12 00 AE         [24]  607 	lcall	_delay_1ms
      0000A7 D0 06            [24]  608 	pop	ar6
      0000A9 D0 07            [24]  609 	pop	ar7
      0000AB 80 EA            [24]  610 	sjmp	00101$
      0000AD                        611 00104$:
                                    612 ;	lib/delay.c:21: }
      0000AD 22               [24]  613 	ret
                                    614 ;------------------------------------------------------------
                                    ...
                                    620 ;	-----------------------------------------
      0000AE                        621 _delay_1ms:
                                    622 ;	lib/delay.c:25: TH0 = 0;
      0000AE 75 8C 00         [24]  623 	mov	_TH0,#0x00
                                    624 ;	lib/delay.c:26: TL0 = 0;
      0000B1 75 8A 00         [24]  625 	mov	_TL0,#0x00
                                    626 ;	lib/delay.c:27: TR0 = 1;
                                    627 ;	assignBit
      0000B4 D2 8C            [12]  628 	setb	_TR0
                                    629 ;	lib/delay.c:28: while (TH0 * 256 + TL0 < 16000) {
      0000B6                        630 00101$:
      0000B6 AF 8C            [24]  631 	mov	r7,_TH0
      0000B8 7E 00            [12]  632 	mov	r6,#0x00
      0000BA AC 8A            [24]  633 	mov	r4,_TL0
      0000BC 7D 00            [12]  634 	mov	r5,#0x00
      0000BE EC               [12]  635 	mov	a,r4
      0000BF 2E               [12]  636 	add	a, r6
      0000C0 FE               [12]  637 	mov	r6,a
      0000C1 ED               [12]  638 	mov	a,r5
      0000C2 3F               [12]  639 	addc	a, r7
      0000C3 FF               [12]  640 	mov	r7,a
      0000C4 C3               [12]  641 	clr	c
      0000C5 EE               [12]  642 	mov	a,r6
      0000C6 94 80            [12]  643 	subb	a,#0x80
      0000C8 EF               [12]  644 	mov	a,r7
      0000C9 64 80            [12]  645 	xrl	a,#0x80
      0000CB 94 BE            [12]  646 	subb	a,#0xbe
      0000CD 40 E7            [24]  647 	jc	00101$
                                    648 ;	lib/delay.c:30: TR0 = 0;
                                    649 ;	assignBit
      0000CF C2 8C            [12]  650 	clr	_TR0
                                    651 ;	lib/delay.c:32: }
      0000D1 22               [24]  652 	ret
                                    653 	.area CSEG    (CODE)
                                    654 	.area CONST   (CODE)
                                    655 	.area XINIT   (CODE)

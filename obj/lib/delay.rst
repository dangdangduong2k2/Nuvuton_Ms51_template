      ...
      000000                        491 	.ds 8
                                    ...
                                    556 ;------------------------------------------------------------
                                    557 ;	lib/delay.c:6: void Delay_Init(void)
                                    558 ;	-----------------------------------------
                                    559 ;	 function Delay_Init
                                    560 ;	-----------------------------------------
      00007A                        561 _Delay_Init:
                           000007   562 	ar7 = 0x07
                           000006   563 	ar6 = 0x06
                           000005   564 	ar5 = 0x05
                           000004   565 	ar4 = 0x04
                           ...
                           000001   568 	ar1 = 0x01
                           000000   569 	ar0 = 0x00
                                    570 ;	lib/delay.c:8: TMOD |= (1 << 0);
      00007A 43 89 01         [24]  571 	orl	_TMOD,#0x01
                                    572 ;	lib/delay.c:9: TMOD &= ~(1 << 1);
      00007D 53 89 FD         [24]  573 	anl	_TMOD,#0xfd
                                    574 ;	lib/delay.c:10: CKCON |= (1 << 3);
      000080 43 8E 08         [24]  575 	orl	_CKCON,#0x08
                                    576 ;	lib/delay.c:11: TMOD &= ~(1 << 2);
      000083 53 89 FB         [24]  577 	anl	_TMOD,#0xfb
                                    578 ;	lib/delay.c:12: TMOD &= ~(1 << 3);
      000086 53 89 F7         [24]  579 	anl	_TMOD,#0xf7
                                    580 ;	lib/delay.c:13: }
      000089 22               [24]  581 	ret
                                    582 ;------------------------------------------------------------
                                    583 ;Allocation info for local variables in function 'Delay_Ms'
                                    584 ;------------------------------------------------------------
                                    585 ;u16Delay                  Allocated to registers 
                                    586 ;------------------------------------------------------------
                                    587 ;	lib/delay.c:15: void Delay_Ms(uint16_t u16Delay)
                                    588 ;	-----------------------------------------
                                    589 ;	 function Delay_Ms
                                    590 ;	-----------------------------------------
      00008A                        591 _Delay_Ms:
      00008A AE 82            [24]  592 	mov	r6, dpl
      00008C AF 83            [24]  593 	mov	r7, dph
                                    594 ;	lib/delay.c:17: while (u16Delay) {
      00008E                        595 00101$:
      00008E EE               [12]  596 	mov	a,r6
      00008F 4F               [12]  597 	orl	a,r7
      000090 60 12            [24]  598 	jz	00104$
                                    599 ;	lib/delay.c:18: --u16Delay;
      000092 1E               [12]  600 	dec	r6
      000093 BE FF 01         [24]  601 	cjne	r6,#0xff,00120$
      000096 1F               [12]  602 	dec	r7
      000097                        603 00120$:
                                    604 ;	lib/delay.c:19: delay_1ms();
      000097 C0 07            [24]  605 	push	ar7
      000099 C0 06            [24]  606 	push	ar6
      00009B 12 00 A5         [24]  607 	lcall	_delay_1ms
      00009E D0 06            [24]  608 	pop	ar6
      0000A0 D0 07            [24]  609 	pop	ar7
      0000A2 80 EA            [24]  610 	sjmp	00101$
      0000A4                        611 00104$:
                                    612 ;	lib/delay.c:21: }
      0000A4 22               [24]  613 	ret
                                    614 ;------------------------------------------------------------
                                    615 ;Allocation info for local variables in function 'delay_1ms'
                                    616 ;------------------------------------------------------------
                                    617 ;	lib/delay.c:23: void delay_1ms(void)
                                    618 ;	-----------------------------------------
                                    619 ;	 function delay_1ms
                                    620 ;	-----------------------------------------
      0000A5                        621 _delay_1ms:
                                    622 ;	lib/delay.c:25: TH0 = 0;
      0000A5 75 8C 00         [24]  623 	mov	_TH0,#0x00
                                    624 ;	lib/delay.c:26: TL0 = 0;
      0000A8 75 8A 00         [24]  625 	mov	_TL0,#0x00
                                    626 ;	lib/delay.c:27: TR0 = 1;
                                    627 ;	assignBit
      0000AB D2 8C            [12]  628 	setb	_TR0
                                    629 ;	lib/delay.c:28: while (TH0 * 256 + TL0 < 16000) {
      0000AD                        630 00101$:
      0000AD AF 8C            [24]  631 	mov	r7,_TH0
      0000AF 7E 00            [12]  632 	mov	r6,#0x00
      0000B1 AC 8A            [24]  633 	mov	r4,_TL0
      0000B3 7D 00            [12]  634 	mov	r5,#0x00
      0000B5 EC               [12]  635 	mov	a,r4
      0000B6 2E               [12]  636 	add	a, r6
      0000B7 FE               [12]  637 	mov	r6,a
      0000B8 ED               [12]  638 	mov	a,r5
      0000B9 3F               [12]  639 	addc	a, r7
      0000BA FF               [12]  640 	mov	r7,a
      0000BB C3               [12]  641 	clr	c
      0000BC EE               [12]  642 	mov	a,r6
      0000BD 94 80            [12]  643 	subb	a,#0x80
      0000BF EF               [12]  644 	mov	a,r7
      0000C0 64 80            [12]  645 	xrl	a,#0x80
      0000C2 94 BE            [12]  646 	subb	a,#0xbe
      0000C4 40 E7            [24]  647 	jc	00101$
                                    648 ;	lib/delay.c:30: TR0 = 0;
                                    649 ;	assignBit
      0000C6 C2 8C            [12]  650 	clr	_TR0
                                    651 ;	lib/delay.c:31: }
      0000C8 22               [24]  652 	ret
                                    653 	.area CSEG    (CODE)
                                    654 	.area CONST   (CODE)
                                    655 	.area XINIT   (CODE)
